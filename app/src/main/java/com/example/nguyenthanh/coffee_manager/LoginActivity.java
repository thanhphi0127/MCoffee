...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public void CreateDatabase(){
        //Check file database is exist
        new File(this.getFilesDir() + "/coffee_db.db4o").delete();
        String filePath = this.getFilesDir() + "/coffee_db.db4o";

        //Open database
        ObjectContainer db = Db4oEmbedded.openFile(filePath);

        //Create permission and user to login
        //List permission
        ...
        ObjectSet<User> usrObjectSet = db.queryByExample(User.class);
        for (User usr: usrObjectSet){
            System.out.println("Ho ten: " + usr.getName() + "ID: " + usr.getPer().getPermissionId());
        }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        public void TestDB(){
            new File("database/coffee_db.db4o").delete();
            ObjectContainer db = Db4oEmbedded.openFile("database/coffee_db.db4o");
            db.close();
        }
    }
}
